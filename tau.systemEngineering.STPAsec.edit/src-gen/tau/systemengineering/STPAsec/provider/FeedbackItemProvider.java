 ...
 * @generated
 */
public class FeedbackItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Feedback_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Feedback_id_feature", "_UI_Feedback_type"),
						STPAsecPackage.Literals.FEEDBACK__ID, true, false, false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Feedback_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Feedback_name_feature",
								"_UI_Feedback_type"),
						STPAsecPackage.Literals.FEEDBACK__NAME, true, false, false,
	...
	public void notifyChanged(Notification notification) {
		...
		case STPAsecPackage.FEEDBACK__ID:
		case STPAsecPackage.FEEDBACK__NAME:
