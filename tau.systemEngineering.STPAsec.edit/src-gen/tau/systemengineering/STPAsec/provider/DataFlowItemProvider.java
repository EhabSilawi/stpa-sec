...
public class DataFlowItemProvider extends ControlStructureItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(STPAsecPackage.Literals.DATA_FLOW__DATA_ELMENT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(STPAsecPackage.Literals.DATA_FLOW__DATA_ELMENT,
				STPAsecFactory.eINSTANCE.createDataElment()));
	}
