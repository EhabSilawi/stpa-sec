 ...
 * @generated
 */
public abstract class StructureElementImpl extends MinimalEObjectImpl.Container implements StructureElement {
	/**
	...
	protected EClass eStaticClass() {
		return STPAsecPackage.Literals.STRUCTURE_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, STPAsecPackage.STRUCTURE_ELEMENT__NAME, oldName,
					name));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, STPAsecPackage.STRUCTURE_ELEMENT__DESCRIPTION,
